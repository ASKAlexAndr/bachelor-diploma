...
\begin{frame}{Заключение}
    ...
    \begin{itemize}
        ...
        \item Проведен анализ результатов тестирования по метрикам precision, recall и F1.
        \item Использование сети Inception V3 с оптимизатором SGD и предварительным масштабированием входных значений предпочтительно для данной задачи.
    \end{itemize}
\end{frame}
\begin{frame}
    \centering\Huge
