...
\begin{frame}{Заключение}
    ...
    \begin{itemize}
        ...
        \item Проведен анализ результатов тестирования по метрикам точности, полноты и F1.
        \item Выявлено, что для решения задачи диагностики Covid-19 предпочтительно использовать сеть Inception с оптимизатором SGD.
    \end{itemize}
\end{frame}
\begin{frame}
    \centering\Huge
