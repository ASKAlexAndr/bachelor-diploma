...
\newcommand{\addthreeimghere}[8]{ % Вставка трех рисунков
    \begin{figure}[H]   
        ...
        \caption{#7}
        \label{#8}
        \subcaptionbox{#2}{\includegraphics[width=.2\textwidth]{#1}}   
        % \hfill
        \subcaptionbox{#4}{\includegraphics[width=.2\textwidth]{#3}}
        % \hfill
        \subcaptionbox{#6}{\includegraphics[width=.2\textwidth]{#5}}
    \end{figure}
}
...
\DeclareCaptionLabelFormat{rtable}{#1}
\captionsetup[figure]{justification=centering, labelsep=deffis, textfont=bf,  labelfont=bf, labelformat=empty} % Подпись рисунка по центру
\captionsetup[table]{justification=centerlast, textfont=bf, labelformat=empty, position=above, margin=0em} 
