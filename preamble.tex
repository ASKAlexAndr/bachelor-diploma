...
\renewcommand{\cftloftitlefont}{\bfseries\hspace{0.17\textwidth}\MakeTextUppercase}
\renewcommand{\cftfigfont}{Рисунок }
\addto\captionsrussian{\renewcommand\listfigurename{Список иллюстративного материала}}

% Список табличного материала
\renewcommand{\cftlottitlefont}{\bfseries\hspace{0.2\textwidth}\MakeTextUppercase}
...
\titleformat{\section}{}{}{12.5mm}{\bfseries\centering{\thesection\quad\MakeTextUppercase{#1}}\vspace{1.5em}}
\titleformat{\subsection}[block]{\bfseries\vspace{1em}}{}{12.5mm}{\thesubsection\quad#1\vspace{1em}}
...
\newcommand{\anonsection}[1]{
    ...
    \paragraph{\bfseries\centerline{{#1}}\vspace{1em}}
...
\newcommand{\appsection}[1]{
    \phantomsection
    \paragraph{\bfseries\centerline{{#1}}}
    \addcontentsline{toc}{section}{{#1}}
}

% \newcounter{sections}[section]
